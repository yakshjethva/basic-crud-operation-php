...
class skdb
{
     ...
     *
     * @uses $db = skdb::getInstance();
     *
     * @return skdb Returns the current instance.
     */
     ...
     *
     * @return array|skdb Contains the returned rows from the select query.
     * @throws Exception
     */
     ...
     *
     * @uses $skdb->where('id', 7)->where('title', 'MyTitle');
     *
     ...
     *
     * @uses $skdb->orWhere('id', 7)->orWhere('title', 'MyTitle');
     *
     * @param string $whereProp  The name of the database field.
     * @param mixed  $whereValue The value of the database field.
     * @param string $operator   Comparison operator. Default is =
     ...
     *
     * @uses $skdb->orHaving('SUM(tags) > 10')
     *
     * @param string $havingProp  The name of the database field.
     * @param mixed  $havingValue The value of the database field.
     * @param string $operator    Comparison operator. Default is =
     ...
     *
     * @uses $skdb->join('table1', 'field1 <> field2', 'LEFT')
     *
     ...
     *
     * @uses $skdb->orderBy('id', 'desc')->orderBy('name', 'desc', '^[a-z]')->orderBy('name', 'desc');
     *
    ...
    /**
     * Method creates new skdb object for a subquery generation
     *
    ...
    /**
     * Method returns a copy of a skdb subquery object
     *
     * @return skdb new skdb object
     */
    ...
    /**
     * Get where and what function was called for query stored in skdb->trace
     *
